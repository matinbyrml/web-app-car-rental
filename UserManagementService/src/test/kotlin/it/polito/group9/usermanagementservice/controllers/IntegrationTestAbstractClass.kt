...
import it.polito.group9.usermanagementservice.config.AccessTokenConfigProperties
import java.net.URI
  ...
  companion object {
    ...
    val postgres =
        PostgreSQLContainer("postgres:latest")
            .withDatabaseName("db_usermanagement")
            .withUsername("user_usermanagement")
            .withPassword("pass_usermanagement")
